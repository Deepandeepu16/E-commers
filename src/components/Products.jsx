...
const Products = () => {
  ...
  const isMounted = useRef(true); // ✅ Proper cleanup handling
  ...
  const filterProduct = (category) => {
    const updatedList = allProducts.filter((item) => item.category === category);
    ...
    return (
      <>
        <div className="buttons text-center py-5">
          <button className="btn btn-outline-dark btn-sm m-2" onClick={() => setFilter(allProducts)}>
            All
          </button>
